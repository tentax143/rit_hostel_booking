...
SECRET_KEY = 'django-insecure-q%hyt6e@q_o%c2v+c12^@&t+x&bh+o$en*5$fwua9n9_%y3(g-'
...
INSTALLED_APPS = [
    ...
    'hostel.apps.HostelConfig',  # Use this with the AppConfig
]
...
DATABASES = {
    'default': {
        ...
        'NAME': 'hostel',               # Your database name
    ...
    'admissionform': {
        'ENGINE': 'django.db.backends.mysql',
        'NAME': 'admissionform',               # Your database name
        'USER': 'root',                # Your MySQL username
        'PASSWORD': '',      # Your MySQL password
        'HOST': 'localhost',          # Set to the address of your MySQL server
        'PORT': '3306',               # Default MySQL port
